            ...
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-7">
                        ...
                        @endforeach --}}
                        <div id="myCarousel" style="width:80%" class="carousel slide" data-interval="false" data-ride="carousel" data-pause="hover" >
                            <!-- Indicators -->
                            <ol class="carousel-indicators">
                                @foreach($hinhAnh as $key=>$ha)
                                <li data-target="#myCarousel" data-slide-to="{{$key}}" @if($key===0)class="active" @else @endif></li>
                                @endforeach
                            </ol>
                            <!-- Wrapper for slides -->
                            <div class="carousel-inner">
                                ...
                                @endif
                                    <img src="{{ asset('storage') }}/san-pham/{{ $ha->duong_dan }}" alt="null"style="width:100%;height:430px;" >
                            ...
                            <div class="single-item">
                                ...
                                <div class="single-item-caption">
                                    <a class="add-to-cart pull-left" href="{{ route('add-to-cart',$sale->id) }}"><i
                                            class="fa fa-shopping-cart"></i></a>
                                    <a class="beta-btn primary" href="{{ route('products-detail',$sale->id) }}">Details
